...
!b.os.opera?"3d(":"(";b.feat.cssTransformEnd=!b.os.opera?",0)":")";b.os.android&&!b.os.webkit&&(b.os.android=!1);for(var u=["Webkit","Moz","ms","O"],d=0;d<u.length;d++)""===t.documentElement.style[u[d]+"Transform"]&&(b.feat.cssPrefix=u[d])}function f(b){return b._afmid||(b._afmid=N++)}function e(c,a,u,d){a=b(a);if(a.ns)var h=RegExp("(?:^| )"+a.ns.replace(" "," .* ?")+"(?: |$)");return(x[f(c)]||[]).filter(function(b){return b&&(!a.e||b.e==a.e)&&(!a.ns||h.test(b.ns))&&(!u||b.fn==u||"function"===typeof b.fn&&
"function"===typeof u&&b.fn===u)&&(!d||b.sel==d)})}function b(b){b=(""+b).split(".");return{e:b[0],ns:b.slice(1).sort().join(" ")}}function h(b,c,a){m.isObject(b)?m.each(b,a):b.split(/\s/).forEach(function(b){a(b,c)})}function s(c,a,u,d,e){var s=f(c),g=x[s]||(x[s]=[]);h(a,u,function(a,u){var w=e&&e(u,a),h=w||u,f=function(b){var a=h.apply(c,[b].concat(b.data));!1===a&&b.preventDefault();return a},w=m.extend(b(a),{fn:u,proxy:f,sel:d,del:w,i:g.length});g.push(w);c.addEventListener(w.e,f,!1)})}function F(b,
c,a,d){var s=f(b);h(c||"",a,function(c,a){e(b,c,a,d).forEach(function(c){delete x[s][c.i];b.removeEventListener(c.e,c.proxy,!1)})})}function O(b){var c=m.extend({originalEvent:b},b);m.each(P,function(a,d){c[a]=function(){this[d]=Q;if("stopImmediatePropagation"==a||"stopPropagation"==a)if(b.cancelBubble=!0,!b[a])return;return b[a].apply(b,arguments)};c[d]=R});return c}function D(b,c,a,d,h){s(b,c,a,d,function(c){return function(a){var u,w=m(a.target).closest(d,b).get(0);if(w)return u=m.extend(O(a),
{currentTarget:w,liveFired:b,delegateTarget:b,data:h}),c.apply(w,[u].concat([].slice.call(arguments,1)))}})}function E(b,c){if(c&&b.dispatchEvent){var a=m.Event("destroy",{bubbles:!1});b.dispatchEvent(a)}if((a=f(b))&&x[a]){for(var d in x[a])b.removeEventListener(x[a][d].e,x[a][d].proxy,!1);delete x[a]}}function z(b,c){if(b){var a=b.childNodes;if(a&&0<a.length)for(var d;d<a.length;d++)z(a[d],c);E(b,c)}}var p,t=c.document,A=[],I=A.slice,G={},S=1,T=/<(\w+)[^>]*>/,y={},B={},J={columncount:!0,fontweight:!0,
lineheight:!0,"column-count":!0,"font-weight":!0,"line-height":!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,"z-index":!0,zoom:!0},C="object"===typeof MSApp,v=function(b,c){this.length=0;if(b){if(b instanceof v&&c==p)return b;if(af.isFunction(b))return af(t).ready(b);if(af.isArray(b)&&b.length!=p){for(var a=0;a<b.length;a++)this[this.length++]=b[a];return this}if(af.isObject(b)&&af.isObject(c)){if(b.length==p)b.parentNode==c&&(this[this.length++]=b);else for(a=0;a<b.length;a++)b[a].parentNode==c&&
(this[this.length++]=b[a]);return this}if(af.isObject(b)&&c==p)return this[this.length++]=b,this;if(c!==p){if(c instanceof v)return c.find(b)}else c=t}else return this;return this.selector(b,c)},m=function(b,c){return new v(b,c)};m.is$=function(b){return b instanceof v};m.map=function(b,c){var a,d=[],h;if(m.isArray(b))for(h=0;h<b.length;h++)a=c.apply(b[h],[h,b[h]]),a!==p&&d.push(a);else if(m.isObject(b))for(h in b)b.hasOwnProperty(h)&&"length"!=h&&(a=c(b[h],[h,b[h]]),a!==p&&d.push(a));return af(d)};
m.each=function(b,c){var a;if(m.isArray(b))for(a=0;a<b.length&&!1!==c(a,b[a]);a++);else if(m.isObject(b))for(a in b)if(b.hasOwnProperty(a)&&"length"!=a&&!1===c(a,b[a]))break;return b};m.extend=function(b){b==p&&(b=this);if(1===arguments.length){for(var c in b)this[c]=b[c];return this}I.call(arguments,1).forEach(function(c){for(var a in c)b[a]=c[a]});return b};m.isArray=function(b){return b instanceof Array&&b.push!=p};m.isFunction=function(b){return"function"===typeof b&&!(b instanceof RegExp)};m.isObject=
function(b){return"object"===typeof b&&null!==b};m.fn=v.prototype={namepsace:"appframework",constructor:v,forEach:A.forEach,reduce:A.reduce,push:A.push,indexOf:A.indexOf,concat:A.concat,selector:function(b,c){b=b.trim();if("#"===b[0]&&-1==b.indexOf(".")&&-1==b.indexOf(",")&&-1===b.indexOf(" ")&&-1===b.indexOf(">"))c==t?r(c.getElementById(b.replace("#","")),this):r(q(b,c),this);else if("<"===b[0]&&">"===b[b.length-1]||-1!==b.indexOf("<")&&-1!==b.indexOf(">")){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=
b.trim()}):a.innerHTML=b.trim();r(a.childNodes,this)}else r(q(b,c),this);return this},oldElement:void 0,slice:A.slice,length:0,setupOld:function(b){if(b==p)return m();b.oldElement=this;return b},map:function(b){var c,a=[],d;for(d=0;d<this.length;d++)c=b.apply(this[d],[d,this[d]]),c!==p&&a.push(c);return m(a)},each:function(b){this.forEach(function(c,a){b.call(c,a,c)});return this},ready:function(b){"complete"===t.readyState||"loaded"===t.readyState||!m.os.ie&&"interactive"===t.readyState?b():t.addEventListener("DOMContentLoaded",
b,!1);return this},find:function(b){if(0===this.length)return this;for(var c=[],a,d=0;d<this.length;d++){a=m(b,this[d]);for(var h=0;h<a.length;h++)c.push(a[h])}return m(k(c))},html:function(b,c){if(0===this.length)return this;if(b===p)return this[0].innerHTML;for(var a=0;a<this.length;a++)if(!1!==c&&m.cleanUpContent(this[a],!1,!0),C){var d=this[a];MSApp.execUnsafeLocalFunction(function(){d.innerHTML=b})}else this[a].innerHTML=b;return this},text:function(b){if(0===this.length)return this;if(b===p)return this[0].textContent;
for(var c=0;c<this.length;c++)this[c].textContent=b;return this},css:function(b,a,d){d=d!=p?d:this[0];if(0===this.length)return this;if(a==p&&"string"===typeof b)return c.getComputedStyle(d),d.style[b]?d.style[b]:c.getComputedStyle(d)[b];for(d=0;d<this.length;d++)if(m.isObject(b))for(var h in b)this[d].style[h]="number"===typeof b[h]&&!J[h.toLowerCase()]?b[h]+"px":b[h];else this[d].style[b]="number"===typeof a&&!J[b.toLowerCase()]?a+"px":a;return this},vendorCss:function(b,c,a){return this.css(m.feat.cssPrefix+
...
null,this[b])),this[b].style.display="none");return this},show:function(){if(0===this.length)return this;for(var b=0;b<this.length;b++)"none"==this.css("display",null,this[b])&&(this[b].style.display=this[b].getAttribute("afmOldStyle")?this[b].getAttribute("afmOldStyle"):"block",this[b].removeAttribute("afmOldStyle"));return this},toggle:function(b){if(0===this.length)return this;for(var c=!0===b,a=0;a<this.length;a++)if("none"!=this.css("display",null,this[a])&&(b==p||!1===c))this[a].setAttribute("afmOldStyle",
this.css("display",null,this[a])),this[a].style.display="none";else if("none"==this.css("display",null,this[a])&&(b==p||!0===c))this[a].style.display=this[a].getAttribute("afmOldStyle")?this[a].getAttribute("afmOldStyle"):"block",this[a].removeAttribute("afmOldStyle");return this},val:function(b){if(0===this.length)return b===p?void 0:this;if(b==p)return this[0].value;for(var c=0;c<this.length;c++)this[c].value=b;return this},attr:function(b,c){if(0===this.length)return c===p?void 0:this;if(c===p&&
!m.isObject(b))return this[0].afmCacheId&&y[this[0].afmCacheId][b]?this[0].afmCacheId&&y[this[0].afmCacheId][b]:this[0].getAttribute(b);for(var a=0;a<this.length;a++)if(m.isObject(b))for(var d in b)m(this[a]).attr(d,b[d]);else m.isArray(c)||m.isObject(c)||m.isFunction(c)?(this[a].afmCacheId||(this[a].afmCacheId=m.uuid()),y[this[a].afmCacheId]||(y[this[a].afmCacheId]={}),y[this[a].afmCacheId][b]=c):null===c?(this[a].removeAttribute(b),this[a].afmCacheId&&y[this[a].afmCacheId][b]&&delete y[this[a].afmCacheId][b]):
this[a].setAttribute(b,c);return this},removeAttr:function(b){for(var c=this,a=0;a<this.length;a++)b.split(/\s+/g).forEach(function(d){c[a].removeAttribute(d);c[a].afmCacheId&&y[c[a].afmCacheId][b]&&delete y[c[a].afmCacheId][b]});return this},prop:function(b,c){if(0===this.length)return c===p?void 0:this;if(c===p&&!m.isObject(b)){var a;return this[0].afmCacheId&&B[this[0].afmCacheId][b]?this[0].afmCacheId&&B[this[0].afmCacheId][b]:!(a=this[0][b])&&b in this[0]?this[0][b]:a}for(a=0;a<this.length;a++)if(m.isObject(b))for(var d in b)m(this[a]).prop(d,
b[d]);else m.isArray(c)||m.isObject(c)||m.isFunction(c)?(this[a].afmCacheId||(this[a].afmCacheId=m.uuid()),B[this[a].afmCacheId]||(B[this[a].afmCacheId]={}),B[this[a].afmCacheId][b]=c):null===c&&void 0!==c?m(this[a]).removeProp(b):this[a][b]=c;return this},removeProp:function(b){for(var c=this,a=0;a<this.length;a++)b.split(/\s+/g).forEach(function(d){c[a][d]&&(c[a][d]=void 0);c[a].afmCacheId&&B[c[a].afmCacheId][b]&&delete B[c[a].afmCacheId][b]});return this},remove:function(b){b=m(this).filter(b);
if(b==p)return this;for(var c=0;c<b.length;c++)m.cleanUpContent(b[c],!0,!0),b[c]&&b[c].parentNode&&b[c].parentNode.removeChild(b[c]);return this},addClass:function(b){if(b==p)return this;for(var c=0;c<this.length;c++){var a=this[c].className,d=[],h=this;b.split(/\s+/g).forEach(function(b){h.hasClass(b,h[c])||d.push(b)});this[c].className+=(a?" ":"")+d.join(" ");this[c].className=this[c].className.trim()}return this},removeClass:function(b){if(b==p)return this;for(var c=0;c<this.length;c++){if(b==
p){this[c].className="";break}var a=this[c].className;"object"==typeof this[c].className&&(a=" ");b.split(/\s+/g).forEach(function(b){a=a.replace(l(b)," ")});this[c].className=0<a.length?a.trim():""}return this},toggleClass:function(b,c){if(b==p)return this;for(var a=0;a<this.length;a++)"boolean"!=typeof c&&(c=this.hasClass(b,this[a])),m(this[a])[c?"removeClass":"addClass"](b);return this},replaceClass:function(b,c){if(b==p||c==p)return this;for(var a=0;a<this.length;a++)if(b==p)this[a].className=
c;else{var d=this[a].className;b.split(/\s+/g).concat(c.split(/\s+/g)).forEach(function(b){d=d.replace(l(b)," ")});d=d.trim();this[a].className=0<d.length?(d+" "+c).trim():c}return this},hasClass:function(b,c){if(0===this.length)return!1;c||(c=this[0]);return l(b).test(c.className)},append:function(b,a){if(b&&b.length!=p&&0===b.length)return this;if(m.isArray(b)||m.isObject(b))b=m(b);var d,h;for(d=0;d<this.length;d++)if(b.length&&"string"!=typeof b)b=m(b),n(b,this[d],a);else{var e=T.test(b)?m(b):
void 0;if(e==p||0===e.length)e=t.createTextNode(b);if(e instanceof v)for(var f=0,s=e.length;f<s;f++)h=e[f],h.nodeName!=p&&"script"==h.nodeName.toLowerCase()&&(!h.type||"text/javascript"===h.type.toLowerCase())?c.eval(h.innerHTML):n(m(h),this[d],a);else a!=p?this[d].insertBefore(e,this[d].firstChild):this[d].appendChild(e)}return this},appendTo:function(b,c){m(b).append(this);return this},prependTo:function(b){m(b).append(this,!0);return this},prepend:function(b){return this.append(b,1)},insertBefore:function(b,
c){if(0===this.length)return this;b=m(b).get(0);if(!b)return this;for(var a=0;a<this.length;a++)c?b.parentNode.insertBefore(this[a],b.nextSibling):b.parentNode.insertBefore(this[a],b);return this},insertAfter:function(b){this.insertBefore(b,!0)},get:function(b){b=b==p?0:b;0>b&&(b+=this.length);return this[b]?this[b]:void 0},offset:function(){var b;if(0===this.length)return this;if(this[0]==c)return{left:0,top:0,right:0,bottom:0,width:c.innerWidth,height:c.innerHeight};b=this[0].getBoundingClientRect();
return{left:b.left+c.pageXOffset,top:b.top+c.pageYOffset,right:b.right+c.pageXOffset,bottom:b.bottom+c.pageYOffset,width:b.right-b.left,height:b.bottom-b.top}},height:function(b){return 0===this.length?this:b!=p?this.css("height",b):this[0]==this[0].window?c.innerHeight:this[0].nodeType==this[0].DOCUMENT_NODE?this[0].documentElement.offsetHeight:(b=this.css("height").replace("px",""))?+b:this.offset().height},width:function(b){return 0===this.length?this:b!=p?this.css("width",b):this[0]==this[0].window?
c.innerWidth:this[0].nodeType==this[0].DOCUMENT_NODE?this[0].documentElement.offsetWidth:(b=this.css("width").replace("px",""))?+b:this.offset().width},parent:function(b,c){if(0===this.length)return this;for(var a=[],d=0;d<this.length;d++)for(var h=this[d];h.parentNode&&h.parentNode!=t&&!(a.push(h.parentNode),h.parentNode&&(h=h.parentNode),!c););return this.setupOld(m(k(a)).filter(b))},parents:function(b){return this.parent(b,!0)},children:function(b){if(0===this.length)return this;for(var c=[],a=
0;a<this.length;a++)c=c.concat(g(this[a].firstChild));return this.setupOld(m(c).filter(b))},siblings:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)this[a].parentNode&&(c=c.concat(g(this[a].parentNode.firstChild,this[a])));return this.setupOld(m(c).filter(b))},contents:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)this[a].parentNode&&r(this[a].childNodes,c);return this.setupOld(m(c).filter(b))},closest:function(b,c){if(0===this.length)return this;
var a=this[0],d=m(b,c);if(0===d.length)return m();for(;a&&-1==d.indexOf(a);)a=a!==c&&a!==t&&a.parentNode;return m(a)},filter:function(b){if(0===this.length||b==p)return this;for(var c=[],a=0;a<this.length;a++){var d=this[a];d.parentNode&&0<=m(b,d.parentNode).indexOf(d)&&c.push(d)}return this.setupOld(m(k(c)))},not:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++){var d=this[a];d.parentNode&&-1==m(b,d.parentNode).indexOf(d)&&c.push(d)}return this.setupOld(m(k(c)))},data:function(b,
c){var a;if(c)return this.attr("data-"+b,c);a=this.attr("data-"+b);try{a=m.parseJSON(a)}catch(d){}return a},end:function(){return this.oldElement!=p?this.oldElement:m()},clone:function(b){b=!1===b?!1:!0;if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)c.push(this[a].cloneNode(b));return m(c)},size:function(){return this.length},serialize:function(){if(0===this.length)return"";for(var b=[],c=0;c<this.length;c++)this.slice.call(this[c].elements).forEach(function(c){var a=c.getAttribute("type");
if("fieldset"!=c.nodeName.toLowerCase()&&(!c.disabled&&"submit"!=a&&"reset"!=a&&"button"!=a&&("radio"!=a&&"checkbox"!=a||c.checked))&&c.getAttribute("name"))if("select-multiple"==c.type)for(a=0;a<c.options.length;a++)c.options[a].selected&&b.push(c.getAttribute("name")+"="+encodeURIComponent(c.options[a].value));else b.push(c.getAttribute("name")+"="+encodeURIComponent(c.value))});return b.join("&")},eq:function(b){return m(this.get(b))},index:function(b){return b?this.indexOf(m(b)[0]):this.parent().children().indexOf(this[0])},
is:function(b){return!!b&&0<this.filter(b).length}};m.ajaxSettings={type:"GET",beforeSend:a,success:a,error:a,complete:a,context:void 0,timeout:0,crossDomain:null};m.jsonP=function(b){if(C)return b.type="get",b.dataType=null,m.get(b);var a="jsonp_callback"+ ++S,d="",h,e=t.createElement("script");c[a]=function(h){clearTimeout(d);m(e).remove();delete c[a];b.success.call(void 0,h)};-1!==b.url.indexOf("callback=?")?e.src=b.url.replace(/=\?/,"="+a):(h=b.jsonp?b.jsonp:"callback",-1===b.url.indexOf("?")?
...
!1!==h.async)h.async=!0;m.isObject(h.data)&&(h.data=m.param(h.data));"get"===h.type.toLowerCase()&&h.data&&(-1===h.url.indexOf("?")?h.url+="?"+h.data:h.url+="&"+h.data);if(h.dataType)switch(h.dataType){case "script":h.dataType="text/javascript, application/javascript";break;case "json":h.dataType="application/json";break;case "xml":h.dataType="application/xml, text/xml";break;case "html":h.dataType="text/html";break;case "text":h.dataType="text/plain";break;case "jsonp":return m.jsonP(h);default:h.dataType=
"text/html"}else h.dataType="text/html";if(/=\?/.test(h.url))return m.jsonP(h);null===h.crossDomain&&(h.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(h.url)&&RegExp.$2!=c.location.host);h.crossDomain||(h.headers=m.extend({"X-Requested-With":"XMLHttpRequest"},h.headers));var f,s=h.context,g=/^([\w-]+:)\/\//.test(h.url)?RegExp.$1:c.location.protocol;d=new c.XMLHttpRequest;d.onreadystatechange=function(){var b=h.dataType;if(4===d.readyState){clearTimeout(f);var c,a=!1;if(200<=d.status&&300>d.status||0===
d.status&&"file:"==g){if("application/json"===b&&!/^\s*$/.test(d.responseText))try{c=JSON.parse(d.responseText)}catch(e){a=e}else"application/xml, text/xml"===b?c=d.responseXML:"text/html"==b?(c=d.responseText,m.parseJS(c)):c=d.responseText;0===d.status&&0===c.length&&(a=!0);a?h.error.call(s,d,"parsererror",a):h.success.call(s,c,"success",d)}else a=!0,h.error.call(s,d,"error");h.complete.call(s,d,a?"error":"success")}};d.open(h.type,h.url,h.async);h.withCredentials&&(d.withCredentials=!0);h.contentType&&
(h.headers["Content-Type"]=h.contentType);for(var q in h.headers)"string"===typeof h.headers[q]&&d.setRequestHeader(q,h.headers[q]);if(!1===h.beforeSend.call(s,d,h))return d.abort(),!1;0<h.timeout&&(f=setTimeout(function(){d.onreadystatechange=a;d.abort();h.error.call(s,d,"timeout")},h.timeout));d.send(h.data)}catch(k){console.log(k),h.error.call(s,d,"error",k)}return d};m.get=function(b,c){return this.ajax({url:b,success:c})};m.post=function(b,c,a,d){"function"===typeof c&&(a=c,c={});d===p&&(d="html");
return this.ajax({url:b,type:"POST",data:c,dataType:d,success:a})};m.getJSON=function(b,c,a){"function"===typeof c&&(a=c,c={});return this.ajax({url:b,data:c,success:a,dataType:"json"})};m.param=function(b,c){var a=[];if(b instanceof v)b.each(function(){a.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in b)if(!m.isFunction(b[d])){var h=c?c+"["+d+"]":d,e=b[d];a.push(m.isObject(e)?m.param(e,h):h+"="+encodeURIComponent(e))}return a.join("&")};m.parseJSON=function(b){return JSON.parse(b)};
m.parseXML=function(b){if(C)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(b,"text/xml")});else return(new DOMParser).parseFromString(b,"text/xml")};d(m,navigator.userAgent);m.__detectUA=d;m.uuid=function(){var b=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return b()+b()+"-"+b()+"-"+b()+"-"+b()+"-"+b()+b()+b()};m.getCssMatrix=function(b){m.is$(b)&&(b=b.get(0));var a=c.WebKitCSSMatrix||c.MSCSSMatrix;if(b===p)return a?new a:{a:0,b:0,c:0,d:0,
e:0,f:0};b=c.getComputedStyle(b);b=b.webkitTransform||b.transform||b[m.feat.cssPrefix+"Transform"];return a?new a(b):b?(a=b.replace(/[^0-9\-.,]/g,"").split(","),{a:+a[0],b:+a[1],c:+a[2],d:+a[3],e:+a[4],f:+a[5]}):{a:0,b:0,c:0,d:0,e:0,f:0}};m.create=function(b,c){var a,d=new v;if(c||"<"!==b[0]){c.html&&(c.innerHTML=c.html,delete c.html);a=t.createElement(b);for(var h in c)a[h]=c[h];d[d.length++]=a}else a=t.createElement("div"),C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=selector.trim()}):
a.innerHTML=b,r(a.childNodes,d);return d};m.query=function(b,c){if(!b)return new v;c=c||t;return(new v).selector(b,c)};var x={},N=1;m.event={add:s,remove:F};m.fn.bind=function(b,c){for(var a=0,d=this.length;a<d;a++)s(this[a],b,c);return this};m.fn.unbind=function(b,c){for(var a=0,d=this.length;a<d;a++)F(this[a],b,c);return this};m.fn.one=function(b,c){return this.each(function(a,d){s(this,b,c,null,function(b,c){return function(){F(d,c,b);return b.apply(d,arguments)}})})};var Q=function(){return!0},
R=function(){return!1},P={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};m.fn.delegate=function(b,c,a,d){m.isFunction(a)&&(d=a,a=null);for(var h=0,e=this.length;h<e;h++)D(this[h],c,d,b,a);return this};m.fn.undelegate=function(b,c,a){for(var d=0,h=this.length;d<h;d++)F(this[d],c,a,b);return this};m.fn.on=function(b,c,a,d){m.isFunction(a)&&(d=a,a=null);return c===p||m.isFunction(c)?this.bind(b,c):this.delegate(c,b,
a,d)};m.fn.off=function(b,c,a){return c===p||m.isFunction(c)?this.unbind(b,c):this.undelegate(c,b,a)};m.fn.trigger=function(b,c,a){"string"==typeof b&&(b=m.Event(b,a));b.data=c;c=0;for(a=this.length;c<a;c++)this[c].dispatchEvent(b);return this};m.Event=function(b,c){var a=t.createEvent("Events"),d=!0;if(c)for(var h in c)"bubbles"==h?d=!!c[h]:a[h]=c[h];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});
m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||(c=[c]);m.isArray(a)||(a=[]);for(var h=0;h<c.length;h++)if(b.__events[c[h]])for(var e=b.__events[c[h]].slice(0),f=0;f<e.length;f++)m.isFunction(e[f])&&!1===e[f].apply(b,a)&&(d=!1);return d}};m.unbind=function(b,c,a){if(b.__events){m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)if(b.__events[c[d]])for(var h=
b.__events[c[d]],e=0;e<h.length;e++)if(a==p&&delete h[e],h[e]==a){h.splice(e,1);break}}};m.proxy=function(b,c,a){return function(){return a?b.apply(c,a):b.apply(c,arguments)}};var U=function(b,c){for(var a=0;a<b.length;a++)z(b[a],c)};m.cleanUpContent=function(b,c,a){if(b){var d=b.childNodes;d&&0<d.length&&m.asap(U,{},[I.apply(d,[0]),a]);c&&E(b,a)}};var H=[],K=[],L=[];m.asap=function(b,a,d){if(!m.isFunction(b))throw"$.asap - argument is not a valid function";H.push(b);K.push(a?a:{});L.push(d?d:[]);
c.postMessage("afm-asap","*")};c.addEventListener("message",function(b){b.source==c&&"afm-asap"==b.data&&(b.stopPropagation(),0<H.length&&H.shift().apply(K.shift(),L.shift()))},!0);var M={};m.parseJS=function(b){if(b){if("string"==typeof b){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b}):a.innerHTML=b;b=a}var d=b.getElementsByTagName("script");b=null;for(var h=0;h<d.length;h++)if(0<d[h].src.length&&!M[d[h].src]&&!C){var e=t.createElement("script");e.type=d[h].type;
e.src=d[h].src;t.getElementsByTagName("head")[0].appendChild(e);M[d[h].src]=1;e=null}else c.eval(d[h].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(b){m.fn[b]=function(c){return c?this.bind(b,c):this.trigger(b)}});["focus","blur"].forEach(function(b){m.fn[b]=function(c){if(0!==this.length){if(c)this.bind(b,c);else for(c=0;c<this.length;c++)try{this[c][b]()}catch(a){}return this}}});return m}(window);window.jq=af;"$"in window||(window.$=
...
break;case "scroll":this.onScroll(a);break;case "orientationchange":this.onOrientationChange(a);break;case "resize":this.onResize(a);break;case "focusin":this.onFocusIn(a)}},launchFixUI:function(a){a||(a=2);if(null===this.reHideAddressBarTimeout_)return this.testAndFixUI(0,a)},resetFixUI:function(){this.reHideAddressBarTimeout_&&clearTimeout(this.reHideAddressBarTimeout_);this.reHideAddressBarTimeout_=null},testAndFixUI:function(a,b){var d=this.getReferenceHeight(),f=this.getCurrentHeight();if(d!==
f&&!(0.97*f<d&&0.97*d<f))return this.hideAddressBar(a,b),!0;c.os.android&&this.resetFixUI();return!1},hideAddressBar:function(a,b){if(!c.ui||!c.ui.isIntel)if(a>=b)this.resetFixUI();else if(c.os.desktop||c.os.kindle)this.layer.style.height="100%";else if(c.os.android){window.scrollTo(1,1);this.layer.style.height=this.isFocused_||window.innerHeight>=window.outerHeight?window.innerHeight+"px":window.outerHeight+"px";var d=a+1;this.reHideAddressBarTimeout_=setTimeout(this.retestAndFixUIProxy_,250*d,d,
b)}else this.isFocused_||(document.documentElement.style.height="5000px",window.scrollTo(0,0),document.documentElement.style.height=window.innerHeight+"px",this.layer.style.height=window.innerHeight+"px")},getReferenceHeight:function(){return window.innerHeight},getCurrentHeight:function(){return c.os.android?window.innerHeight:numOnly(document.documentElement.style.height)},onOrientationChange:function(a){var b=this;a=!1;this.focusedElement&&(a=!0,this.focusedElement.blur());!this.holdingReshapeType_&&
this.reshapeTimeout_?this.fireReshapeEvent("orientationchange"):this.previewReshapeEvent("orientationchange");c.os.android&&c.os.chrome&&(this.layer.style.height="100%",setTimeout(function(){b.hideAddressBar(0,1)},a?600:0))},onResize:function(a){this.ignoreNextResize_?this.ignoreNextResize_=!1:this.launchFixUI()&&this.reshapeAction()},onClick:function(a){var b=a.target&&void 0!==a.target.tagName?a.target.tagName.toLowerCase():"";if(-1!==n.indexOf(b)&&(!this.isFocused_||a.target!==this.focusedElement)){b=
a.target&&void 0!==a.target.type?a.target.type.toLowerCase():"";if(-1===l.indexOf(b)){this.isFocused_&&this.focusedElement.removeEventListener("blur",this,!1);this.focusedElement=a.target;this.focusedElement.addEventListener("blur",this,!1);if(!this.isFocused_&&!this.justBlurred_)if(c.trigger(this,"enter-edit",[a.target]),c.os.ios){var d=this;setTimeout(function(){d.fireReshapeEvent("enter-edit")},300)}else this.previewReshapeEvent("enter-edit");this.isFocused_=!0}else this.isFocused_=!1;this.justBlurred_=
!1;this.allowDocumentScroll_=!0;k&&a.target.focus()}else c.os.blackberry10&&this.isFocused_&&this.focusedElement.blur()},previewReshapeEvent:function(a){var b=this;this.reshapeTimeout_=setTimeout(function(){b.fireReshapeEvent(a);b.reshapeTimeout_=null;b.holdingReshapeType_=null},750);this.holdingReshapeType_=a},fireReshapeEvent:function(a){c.trigger(this,"reshape");c.trigger(this,a?a+"-reshape":"unknown-reshape")},reshapeAction:function(){this.reshapeTimeout_?(clearTimeout(this.reshapeTimeout_),this.fireReshapeEvent(this.holdingReshapeType_),
this.reshapeTimeout_=this.holdingReshapeType_=null):this.previewReshapeEvent()},onFocusIn:function(a){if(!this.isFocused_)this.onClick(a)},onBlur:function(a){c.os.android&&a.target===window||(this.isFocused_=!1,this.focusedElement&&this.focusedElement.removeEventListener("blur",this,!1),this.focusedElement=null,this.justBlurred_=!0,c.asap(this.exitEditProxy_,this,[a.target]))},exitExit:function(a){this.justBlurred_=!1;if(!this.isFocused_)if(c.trigger(this,"exit-edit",[a]),this.allowDocumentScroll_=
!1,c.os.ios){var b=this;setTimeout(function(){b.fireReshapeEvent("exit-edit")},300)}else this.previewReshapeEvent("exit-edit")},onScroll:function(a){!this.allowDocumentScroll_&&(!this.isPanning_&&a.target===document)&&(this.allowDocumentScroll_=!0,this.wasPanning_?(this.wasPanning_=!1,setTimeout(this.launchFixUIProxy_,2E3,[2])):this.launchFixUI())},onTouchStart:function(e){this.dX=e.touches[0].pageX;this.dY=e.touches[0].pageY;this.lastTimestamp=e.timeStamp;this.lastTouchStartX=this.lastTouchStartY=
null;if(c.os.ios){if(a===e.touches[0].identifier)return d=!0,e.preventDefault(),a=!1;a=e.touches[0].identifier;d=!1}if(this.scrollerIsScrolling)return this.moved=!0,this.scrollerIsScrolling=!1,e.preventDefault(),!1;this.trackingClick=!0;(r||c.feat.nativeTouchScroll)&&this.checkDOMTree(e.target,this.layer);this.isScrolling&&(null!==this.scrollTimeout_?(clearTimeout(this.scrollTimeout_),this.scrollTimeout_=null,this.scrollTimeoutEl_!==this.scrollingEl_?this.scrollEnded(!1):this.blockPossibleClick_=
!0):this.scrollTimeoutEl_&&(this.scrollEnded(!0),this.blockPossibleClick_=!0));if(c.os.android&&e&&e.target&&e.target.getAttribute&&"ignore"===e.target.getAttribute("data-touchlayer")||this.isFocused_&&!c.os.blackberry10)this.allowDocumentScroll_=this.requiresNativeTap=!0;else if(q&&e.target&&void 0!==e.target.tagName){var b=e.target.tagName.toLowerCase();-1!==n.indexOf(b)&&(this.requiresNativeTap=!0)}else e.target&&(void 0!==e.target.tagName&&"input"===e.target.tagName.toLowerCase()&&"range"===e.target.type)&&
(this.requiresNativeTap=!0);!this.isPanning_&&!this.requiresNativeTap?(this.isScrolling&&!c.feat.nativeTouchScroll||!this.isScrolling)&&e.preventDefault():this.isScrollingVertical_&&this.demandVerticalScroll()},demandVerticalScroll:function(){0>=this.scrollingEl_.scrollTop?this.scrollingEl_.scrollTop=1:this.scrollingEl_.scrollTop+this.scrollingEl_.clientHeight>=this.scrollingEl_.scrollHeight&&(this.scrollingEl_.scrollTop=this.scrollingEl_.scrollHeight-this.scrollingEl_.clientHeight-1)},ignoreScrolling:function(a){return void 0===
...
this.moved;g&&(b=b&&!(10>Math.abs(this.cX)&&10>Math.abs(this.cY)));if(!c.os.ios||!this.requiresNativeTap)this.allowDocumentScroll_=!1;if(this.isPanning_&&b)this.wasPanning_=!0;else if(!b&&!this.requiresNativeTap){this.scrollerIsScrolling=!1;if(!this.trackingClick)return;a.preventDefault();if(!this.blockClicks&&!this.blockPossibleClick_){var b=a.target,d=a.changedTouches?a.changedTouches[0]:a.touches[0];3===b.nodeType&&(b=b.parentNode);this.fireEvent("Event","click",b,!0,a.mouseToTouch,d[0]);this.lastTouchStartX=
this.dX;this.lastTouchStartY=this.dY}}else b&&(this.isScrolling&&(this.scrollTimeoutEl_=this.scrollingEl_,0.01>Math.abs(this.speedY)?this.scrollEnded(!1):this.scrollTimeout_=setTimeout(this.scrollTimeoutExpireProxy_,30)),this.requiresNativeTap&&(this.isFocused_||c.trigger(this,"cancel-enter-edit",[a.target])));c.os.blackberry10&&(this.lastTouchStartX=this.dX,this.lastTouchStartY=this.dY);this.clearTouchVars()},clearTouchVars:function(){this.speedY=this.lastY=this.cY=this.cX=this.dX=this.dY=0;this.trackingClick=
this.blockPossibleClick_=this.requiresNativeTap=this.isScrollingVertical_=this.isScrolling=this.isPanning_=this.moved=!1},fireEvent:function(a,b,d,f,g,k){var l=document.createEvent(a);l.initEvent(b,f,!0);k&&c.each(k,function(a,b){l.key=b});g&&(l.mouseToTouch=!0);d.dispatchEvent(l)}}})(af);
(function(c){var n=window.location.pathname+window.location.search,l=window.location.hash,k=l,g=function(){function a(b){"afui"===b.target.id&&(d(),c(document).unbind("DOMNodeInserted",a))}function d(){f.useOSThemes&&(c.os.android?c("#afui").addClass("android"):c.os.ie?c("#afui").addClass("win8"):c.os.blackberry||c.os.blackberry10||c.os.playbook?(c("#afui").addClass("bb"),f.backButtonText="Back"):c.os.ios7?c("#afui").addClass("ios7"):c.os.ios&&c("#afui").addClass("ios"));c.os.ios&&(c("head").find("#iosBlurrHack").remove(),
c("head").append("<style id='iosBlurrHack'>#afui .panel > * {-webkit-backface-visibility: hidden;-webkit-perspective: 1000;}</style>"))}var f=this;this.availableTransitions={};this.availableTransitions["default"]=this.availableTransitions.none=this.noTransition;1===c("#afui").length?d():c(document).bind("DOMNodeInserted",a);var e=function(){var a=document.getElementById("afui");if(null===a){a=document.createElement("div");a.id="afui";for(var e=document.body;e&&e.firstChild;)a.appendChild(e.firstChild);
c(document.body).prepend(a)}c.os.supportsTouch&&c.touchLayer(a);d()};if("intel"in window)document.addEventListener("intel.xdk.device.ready",function(){e();f.autoBoot()},!0);else if("complete"==document.readyState||"loaded"==document.readyState)if(e(),f.init)f.autoBoot();else c(window).one("afui:init",function(){f.autoBoot()});else c(document).ready(function(){e();if(f.init)f.autoBoot();else c(window).one("afui:init",function(){f.autoBoot()})},!1);"intel"in window||(window.intel={xdk:{}},window.intel.xdk.webRoot=
"");window.addEventListener("popstate",function(){if(f.useInteralRouting){var a=f.getPanelId(document.location.hash);"#"!=document.location.href.replace(document.location.origin+"/","")&&(""===a&&1===f.history.length&&(a="#"+f.firstDiv.id),""!==a&&0!==af(a).filter(".panel").length&&a!="#"+f.activeDiv.id&&f.goBack())}},!1)};g.prototype={init:!1,transitionTime:"100ms",showLoading:!0,loadingText:"Loading Content",loadContentQueue:[],isIntel:!1,titlebar:"",navbar:"",header:"",viewportContainer:"",remotePages:{},
history:[],homeDiv:"",screenWidth:"",content:"",modalWindow:"",customFooter:!1,defaultFooter:"",defaultHeader:null,customMenu:!1,defaultMenu:"",_readyFunc:null,doingTransition:!1,passwordBox:c.passwordBox?new c.passwordBox:!1,selectBox:c.selectBox?c.selectBox:!1,ajaxUrl:"",transitionType:"slide",scrollingDivs:{},firstDiv:"",hasLaunched:!1,launchCompleted:!1,activeDiv:"",customClickHandler:"",menuAnimation:null,togglingSideMenu:!1,sideMenuWidth:"200px",handheldMinWidth:"768",trimBackButtonText:!0,
...
!1},manageHistory:!0,loadDefaultHash:!0,useAjaxCacheBuster:!1,actionsheet:function(a){return c.query("#afui").actionsheet(a)},popup:function(a){return c.query("#afui").popup(a)},blockUI:function(a){c.blockUI(a)},unblockUI:function(){c.unblockUI()},removeFooterMenu:function(){c.query("#navbar").hide();c.query("#content").css("bottom","0px");this.showNavMenu=!1},showNavMenu:!0,autoLaunch:!0,showBackbutton:!0,showBackButton:!0,backButtonText:"",resetScrollers:!0,ready:function(a){if(this.launchCompleted)a();
else c(document).on("afui:ready",function(c){a()})},setBackButtonStyle:function(a){c.query("#header #backButton").get(0).className=a},goBack:function(a){if(a=Math.min(Math.abs(~~a||1),this.history.length))a=this.history.splice(-a).shift(),this.loadContent(a.target+"",0,1,a.transition),this.transitionType=a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},pushHistory:function(a,d,f,e){this.history.push({target:a,transition:f});try{this.manageHistory&&
(window.history.pushState(d,d,n+"#"+d+e),c(window).trigger("hashchange",null,{newUrl:n+"#"+d+e,oldURL:n+a}))}catch(b){}},updateHash:function(a){if(this.manageHistory){k=a=-1==a.indexOf("#")?"#"+a:a;var d=window.location.hash,f=this.getPanelId(a).substring(1);try{window.history.replaceState(f,f,n+a),c(window).trigger("hashchange",null,{newUrl:n+a,oldUrl:n+d})}catch(e){}}},getPanelId:function(a){var c=a.indexOf("/");return-1==c?a:a.substring(0,c)},updateBadge:function(a,d,f,e){void 0===f&&(f="");a=
c(a);var b=a.find("span.af-badge");0===b.length?("absolute"!=a.css("position")&&a.css("position","relative"),b=c.create("span",{className:"af-badge "+f,html:d}),a.append(b)):b.html(d);b.removeClass("tl bl br tr");b.addClass(f);void 0===e&&(e="red");c.isObject(e)?b.css(e):e&&b.css("background",e);b.data("ignore-pressed","true")},removeBadge:function(a){c(a).find("span.af-badge").remove()},toggleNavMenu:function(a){if(this.showNavMenu)if("none"!=c.query("#navbar").css("display")&&(void 0!==a&&!0!==
...
toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),h=c.query("#content,  #header, #navbar"),g=c.query(".afui_panel_mask");f=f||this.transitionTime;var k=this.isSideMenuOn();0===g.length&&window.innerWidth<c.ui.handheldMinWidth&&(h.append('<div class="afui_panel_mask"></div>'),g=c.query(".afui_panel_mask"),c(".afui_panel_mask").bind("click",function(){c.ui.toggleSideMenu(!1)}));if(2===a||!k&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=
!0,b.show(),e.css3animate(h,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;h.vendorCss("Transition","");d&&d(a);0!==g.length&&window.innerWidth<c.ui.handheldMinWidth&&g.show()}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(h,{x:"0px",time:f,complete:function(a){h.vendorCss("Transition","");h.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide();0!==g.length&&window.innerWidth<c.ui.handheldMinWidth&&g.hide()}})}},disableSideMenu:function(){var a=
c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},isSideMenuEnabled:function(){return c.query("#content").hasClass("hasMenu")},isSideMenuOn:function(){var a=1<parseInt(c.getCssMatrix(c("#content")).e)?!0:!1;return this.isSideMenuEnabled()&&
a},prevFooter:null,updateNavbarElements:function(a){this.prevFooter&&(this.prevFooter.data("parent")?this.prevFooter.appendTo("#"+this.prevFooter.data("parent")):this.prevFooter.appendTo("#afui"));c.is$(a)||(a=c.query("#"+a));c.query("#navbar").append(a);this.prevFooter=a;a=c.query("#navbar a");if(0<a.length){a.data("ignore-pressed","true").data("resetHistory","true");var d=parseFloat(100/a.length);a.css("width",d+"%")}a=c.query("#navbar footer");if(0!==a.length){a=a.get(0).childNodes;for(d=0;d<a.length;d++)3===
a[d].nodeType&&a[d].parentNode.removeChild(a[d])}},prevHeader:null,updateHeaderElements:function(a,d){var f=this;c.is$(a)||(a=c.query("#"+a));if(a!=this.prevHeader)if(this._currentHeaderID=a.prop("id"),this.prevHeader)if(c.query("#header").append(a),c.ui.animateHeaders){var e=d?"100px":"-100px",b=d?"-100px":"100px";f.prevHeader.addClass("ignore");f.css3animate(a,{x:b,opacity:0.3,time:"1ms"});f.css3animate(f.prevHeader,{x:e,y:0,opacity:0.3,time:f.transitionTime,delay:numOnly(f.transitionTime)/5+"ms",
complete:function(){f.prevHeader.data("parent")?f.prevHeader.appendTo("#"+f.prevHeader.data("parent")):f.prevHeader.appendTo("#afui");f.prevHeader.removeClass("ignore");f.css3animate(f.prevHeader,{x:b,opacity:1,time:"1ms"});f.prevHeader=a}});f.css3animate(a,{x:"0px",opacity:1,time:f.transitionTime})}else f.prevHeader.data("parent")?f.prevHeader.appendTo("#"+f.prevHeader.data("parent")):f.prevHeader.appendTo("#afui"),f.prevHeader=a;else c.query("#header").append(a),this.prevHeader=a},updateSideMenu:function(a){return this.updateSideMenuElements(a)},
updateSideMenuElements:function(a){if(!(void 0===a||null===a)){var d=c.query("#menu_scroller");this.prevMenu&&(this.prevMenu.insertBefore("#afui #menu"),this.prevMenu=null);c.is$(a)||(a=c.query("#"+a));d.html("");d.append(a);this.prevMenu=a;this.scrollingDivs.menu_scroller.hideScrollbars();this.scrollingDivs.menu_scroller.scrollToTop()}},setTitle:function(a){"defaultHeader"===this._currentHeaderID&&c.query("#header header:not(.ignore)  #pageTitle").html(a)},setBackButtonText:function(a){"defaultHeader"===
this._currentHeaderID&&(this.trimBackButtonText&&7<=a.length&&(a=a.substring(0,5)+"..."),0<this.backButtonText.length?c.query("#header header:not(.ignore) #backButton").html(this.backButtonText):c.query("#header header:not(.ignore)  #backButton").html(a))},setBackButtonVisibility:function(a){a?c.query("#header #backButton").css("visibility","visible"):c.query("#header #backButton").css("visibility","hidden")},showMask:function(a){a||(a=this.loadingText||"");c.query("#afui_mask>h1").html(a);c.query("#afui_mask").show()},
